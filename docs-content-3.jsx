  ...
  return (
    <>
      ...
      <section id="client-download">
        ...
        <ul>
          <li><a href="https://github.com/CloudNativeWorks/elchi-archive/releases/download/elchi-client-v1.1.0/elchi-client-linux-amd64">elchi-client-linux-amd64</a></li>
          <li><a href="https://github.com/CloudNativeWorks/elchi-archive/releases/download/elchi-client-v1.1.0/elchi-client-linux-amd64.sha256">elchi-client-linux-amd64.sha256</a></li>
        </ul>
      </section>
      ...
      <section id="client-install">
        ...
        <Code lang="shell">{T.c('# Fetch the installer\n')}{T.cmd('wget')} {T.s('https://github.com/CloudNativeWorks/elchi-archive/releases/download/elchi-client-v1.1.0/elchi-install.sh')}</Code>
