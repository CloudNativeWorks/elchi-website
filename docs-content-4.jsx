  ...
  return (
    <>
        ...
        <div className="docs-table-wrap">
          <table className="docs-table">
            ...
            <tbody>
              ...
              <tr><td className="param">--ui-version=&lt;vX.Y.Z&gt;</td><td>UI bundle version (<code>elchi-dist-vX.Y.Z.tar.gz</code> from elchi releases).</td><td className="default">v1.4.1</td></tr>
      ...
      <section id="baremetal-upgrade">
        ...
        <Code lang="shell">{T.cmd('curl')} {T.f('-fsSL')} {T.s('.../get.sh')} | {T.cmd('sudo bash')} {T.f('-s')} {T.f('--')} {T.f('--upgrade')} {T.f('--ui-version')}={T.s('v1.4.1')}</Code>
