  ...
  return (
    <>
      ...
      <section id="baremetal-quickstart">
        ...
        <Code lang="shell">{T.cmd('curl')} {T.f('-fsSL')} {T.s('https://raw.githubusercontent.com/CloudNativeWorks/elchi-archive/main/deploy/standalone/get.sh')} {'\\\n'}  | {T.cmd('sudo bash')} {T.f('-s')} {T.f('--')} {'\\\n'}      {T.f('--nodes')}={T.s('10.10.10.2,10.10.10.3,10.10.10.4')} {'\\\n'}      {T.f('--ssh-bootstrap')} {'\\\n'}      {T.f('--main-address')}={T.s('elchi.example.com')} {'\\\n'}      {T.f('--gslb-zone')}={T.s('gslb.example.com')} {'\\\n'}      {T.f('--backend-version')}={T.s('elchi-v1.4.8-v0.14.0-envoy1.36.2')}</Code>
      ...
      <section id="baremetal-install">
        ...
        <p>Every variant tag in <code>--backend-version</code> is a full release-asset name (<code>elchi-vX.Y.Z-vA.B.C-envoyP.Q.R</code>), downloaded from the public <a href="https://github.com/CloudNativeWorks/elchi-archive/releases">elchi-archive releases</a> — the binaries are mirrored there from the private <code>elchi-backend</code> repo by the <code>build-elchi-backend</code> workflow. Multiple variants are comma-separated and each gets its own systemd template unit + <code>/etc/elchi/&lt;variant&gt;/</code> config dir + <code>/var/lib/elchi/&lt;variant&gt;/</code> HOME dir.</p>
        ...
        <div className="docs-table-wrap">
          <table className="docs-table">
            ...
            <tbody>
              ...
              <tr><td className="param">--ui-version=&lt;vX.Y.Z&gt;</td><td>UI bundle version (<code>elchi-dist-vX.Y.Z.tar.gz</code>). Mirrored to the public elchi-archive releases by the build-elchi-ui workflow.</td><td className="default">v1.4.4</td></tr>
      ...
      <section id="baremetal-upgrade">
        ...
        <Code lang="shell">{T.cmd('curl')} {T.f('-fsSL')} {T.s('https://raw.githubusercontent.com/CloudNativeWorks/elchi-archive/main/deploy/standalone/get.sh')} {'\\\n'}  | {T.cmd('sudo bash')} {T.f('-s')} {T.f('--')} {T.f('--upgrade')} {'\\\n'}      {T.f('--add-backend-version')}={T.s('elchi-v1.4.8-v0.14.0-envoy1.38.0')}</Code>
        ...
        <Code lang="shell">{T.cmd('curl')} {T.f('-fsSL')} {T.s('https://raw.githubusercontent.com/CloudNativeWorks/elchi-archive/main/deploy/standalone/get.sh')} {'\\\n'}  | {T.cmd('sudo bash')} {T.f('-s')} {T.f('--')} {T.f('--upgrade')} {'\\\n'}      {T.f('--backend-version')}={T.s('elchi-v1.4.8-v0.14.0-envoy1.36.2,elchi-v1.4.8-v0.14.0-envoy1.38.0')}</Code>
